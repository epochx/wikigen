...
# impport operator
# max(json_data['quality'].items(), key=operator.itemgetter(1))[0]


class Vocab:

    def __init__(self, min_count=0, add_padding=False, add_bos=False,
                 add_eos=False, unk=None, lowercase=False):
        """
        :param sentences:
